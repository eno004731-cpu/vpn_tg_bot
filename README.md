...
По умолчанию бот следит за активными клиентами в `3x-ui`: после `75 ГБ` за день он выставляет клиенту `speedLimit = 1250`, то есть примерно `10 Мбит/с`. На следующий день скорость снимается.
